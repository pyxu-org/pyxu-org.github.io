...
.. raw:: html
    ...
    <p>
        <strong>Source code</strong>: <a href="https://github.com/joanrue/pyxu-eigh" target="_blank">Go to the source code repository</a>
    </p>
...
.. raw:: html
    ...
    <p>
        <strong>Most recent version</strong>: 1.0.0
    </p>
    <p>
