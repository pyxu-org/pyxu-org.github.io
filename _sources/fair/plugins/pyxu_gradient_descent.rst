...
.. raw:: html
    ...
    <p>
        <strong>Short description</strong>: An accelerated gradient descent optimizer for Pyxu
    </p>
    ...
    <p>
        <strong>Source code</strong>: <a href="https://github.com/joanrue/pyxu-gradient-descent" target="_blank">Go to the source code repository</a>
    </p>
...
.. raw:: html
    ...
    <p>
        <strong>Most recent version</strong>: 1.0.1
    </p>
    <p>
...
.. raw:: html
    <p class="summaryinfo">
      ...
      Solver <span class="entrypointraw">(pyxu.opt.solver)</span>
    
    <ul>
    
    <li><code>GradientDescent</code>
