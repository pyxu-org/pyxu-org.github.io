...
.. raw:: html
    ...
    <p>
        <strong>Short description</strong>: Pyxu X-Ray Transform Operators.
    </p>
    ...
    <p>
        <strong>Source code</strong>: <a href="https://github.com/pyxu-org/pyxu_xrt" target="_blank">Go to the source code repository</a>
    </p>
...
.. raw:: html
    ...
    <p>
        <strong>Most recent version</strong>: 0.7
    </p>
    <p>
