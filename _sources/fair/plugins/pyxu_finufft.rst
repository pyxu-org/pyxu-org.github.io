...
.. raw:: html
    ...
    <p>
        <strong>Short description</strong>: Pyxu bindings to the Flatiron Institute Non-uniform Fast Fourier Transform (FINUFFT) library.
    </p>
    ...
    <p>
        <strong>Source code</strong>: <a href="https://github.com/pyxu-org/pyxu_finufft" target="_blank">Go to the source code repository</a>
    </p>
...
.. raw:: html
    ...
    <p>
        <strong>Author(s)</strong>: "S. Kashani"
    </p>
